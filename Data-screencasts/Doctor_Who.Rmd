...
Is not clear the evidence of influence between Directors and Rating, maybe with cluster analysis it easier.
...
In three PCA is possible understand the effect between directors and rating but  not is the whole story.
...
* The full relation where $y$ is rating are explained with Directors and Writers
...
With the last graph is possible understand the influence for directors in the ratings. Now 
